...
//
// gpt.Table implements the Table interface in github.com/isi-lincoln/go-diskfs/partition
//
// Normally, the best way to interact with a disk is to use the github.com/isi-lincoln/go-diskfs package,
